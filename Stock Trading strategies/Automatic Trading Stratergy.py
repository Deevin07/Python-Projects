...
con = fxcmpy.fxcmpy(access_token = 'Your API Code', log_level = 'error', server='demo')
...
def renko_merge(DF):
    ...
    merged_df["macd"]= MACD(merged_df,12,26,9)[0]                       #first candel
    merged_df["macd_sig"]= MACD(merged_df,12,26,9)[1]                   # second candel
